...
public class Server {
    ...
    private Dish dish = generateTurkeyClubSandwich();
    ...
    public void describeDish(Dish d) {
        System.out.println(d.getDescription());
    }

    //EFFECTS: prints out a greeting
    public void greet() {
        System.out.println("\"Hello and welcome to Busy's, the home of the high class turkey club sandwich.\"");
    }
