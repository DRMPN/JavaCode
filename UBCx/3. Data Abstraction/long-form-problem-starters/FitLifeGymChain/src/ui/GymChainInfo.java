...
public class GymChainInfo {
    ...
    public static final String YOUR_GYM_NAME = "Go grow muscles!";
    public static final String YOUR_MEMBER_NAME = "Giga Chad";
